...
class TestLogIn:
    ...
    def test_log_in__by_entry_button_success(self, driver_fixt):
    ...
    def test_log_in_by_registration_success(self, driver_fixt):
    ...
    def test_log_in_by_restore_password_success(self, driver_fixt):
